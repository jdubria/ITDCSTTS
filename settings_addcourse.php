                 ...
                 <div class="row">
                     <div class="col-sm-2">
                         ...
                         <ul class="nav nav-pills nav-stacked">
                            ...
                            <li class="nav-item">
                                  <a href="settings_addcourse.php" class="nav-link active">Add Course</a>
                             </li>
                            <li class="nav-item">
                     ...
                     <div class="col-sm-10">
                         <div class="container">
                                    ...
                                    <div class="card">
                                     ...
                                     <div class="container">
                                        <div class="jumbotron">
                                            <center><h5><b>List of Courses<b></h5></center>
                                        </div>
                                         <div class="table-responsive">
                                            <div class="pull-left">
                                             <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#course" data-tooltip="tooltip" data-placement="bottom" title="Add Semester"><span class="fa fa-plus"></span> Course</button>
                                            </div>
                                            <br>
                                            <br>    
                                             <table class="table table-sm table-striped table-inverse">
                                                 ...
                                                 while ($row = mysqli_fetch_array($sql)) { ?>
                                                     <tr>
                                                         ...
                                                         <td>
                                                            <div class="btn-group">
                                                             <a href="#edit<?php echo $row['course_id'] ?>" data-toggle="modal" class="btn btn-sm"><span class="fa fa-edit"></span> Edit</a>
                                                             <a href="#archive<?php echo $row['course_id'] ?>" data-toggle="modal" class="btn btn-sm"><span class="fa fa-archive"></span> Archived</a>
                                                            </div>
                                                            <?php include 'modals/buttons_course.php'; ?>
                                                         </td>
                                                     </tr>
                                                <?php
                                                 }
