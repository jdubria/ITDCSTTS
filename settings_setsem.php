                         ...
                         <div class="container">
                             <div class="row">
                                 <div class="col-sm-2">
                                        ...
                                        <ul class="nav nav-pills nav-stacked">
                                             <li class="nav-item">
                                                 <a href="settings.php" class="nav-link">Registered Semesters</a>
                                             </li>
                                             <li class="nav-item">
                                                 <a href="settings_setsem.php" class="nav-link active">Set Semester</a>
                                             </li>
                                         </ul>          
                                 </div>
                                 <div class="col-sm-10">
                                     <div class="card">
                                        ...
                                        <div class="container">
                                            <div class="jumbotron">
                                                <center><h5>Set Semester</h5></center>
                                                <center>
                                                <small class="text-info">If you will set or change the semester, Kindly log-out and re-login again.</small>
                                                </center>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div class="container">
                                                <div class="form-group">
                                                    <label class="pull-left">Current Semester:</label>
                                                    <?php 
                                                    $sql = mysqli_query($conn, "SELECT * FROM `default`
                                                        INNER JOIN semester ON semester.sem_id = default.sem_id;");
                                                ...
                                                <div class="pull-right">
                                                    <button class="btn btn-sm" data-toggle="modal" data-target="#set_sem"><span class="fa fa-refresh"></span> Change Current Semester</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
