             ...
             <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4" style="margin-top: 90px;">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                 ...
                 <div class="pt-3 pb-2 mb-3">
                     <ul class="nav nav-tabs mr-2">
                         ...
                         <li class="nav-item">
                             <a class="nav-link active" href="archive_room.php"><span class="fa fa-home"></span> Archive Rooms </a>
                         </li>
                         <li class="nav-item">
                ...
                <div class="table-responsive">
                                  ...
                                  <table class="table table-striped table-bordered table-sm" id="table">
                                       ...
                                       <tbody>
                                        <?php 
                                        $resultss = mysqli_query($conn, "SELECT * FROM room WHERE active = 0;");
                                        while ($row = mysqli_fetch_array($resultss)) { ?>
                                           <tr>
                                            <td class="text-center"><?php echo $row['name']; ?></td>
                                            <td class="text-center"><?php echo $row['room_type']; ?></td>
                                             <td class="text-center">
                                              <a href="action/restore_room.php?roomid=<?php echo $row['roomid']?>" class="btn btn-sm btn-outline-dark"><strong> Restore </strong></a>
                                              </td>
                                                </tr>
                                                <?php } ?>
