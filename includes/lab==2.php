<?php 
	include "../connection/conn.php";
				...
				if ($CD > 0 && $CS > 0) {
					...
					$newdays = array_slice($day, 0, $size2);
		 			$newstart_time = array_slice($arr, 0, $size2);
		 			$time = '01:00:00';
					...
					$MAXEND = array();
					$rdt_ids = array();
					$newdays = array_slice($dayvalue, 0, $size2);
